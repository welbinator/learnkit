...
- The version of LearnKit affected

## Response Timeline

- We aim to acknowledge reports within 48 hours
- We target a fix within 14 days for critical issues, 30 days for others
- We will coordinate disclosure timing with you once a fix is ready

## Scope

This policy applies to the LearnKit WordPress plugin (`learnkit`) and its official releases.
