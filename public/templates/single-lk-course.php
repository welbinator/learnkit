	...
	<div class="lk-course-hero">
		<div class="lk-course-hero-content">
			<div>
				...
				<?php if ( $is_enrolled ) : ?>
					<a href="<?php echo esc_url( learnkit_lesson_url( $continue_lesson_id ) ); ?>" class="<?php echo esc_attr( learnkit_button_classes( 'continue_learning_button', 'btn--lk-continue' ) ); ?>">
						Continue Learning →
					</a>
						...
						<div class="lk-lessons-list">
							<?php foreach ( $lessons as $lesson ) : ?>
								<div class="lk-lesson-item">
									<?php if ( $is_enrolled ) : ?>
										<a href="<?php echo esc_url( learnkit_lesson_url( $lesson->ID ) ); ?>" class="lk-lesson-title">
