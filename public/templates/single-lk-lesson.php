		...
		<div class="learnkit-lesson-footer">
			<div class="learnkit-lesson-progress">
				<?php if ( is_user_logged_in() ) : ?>
					...
					if ( $quiz_gate_active ) :
						?>
						<button
							class="<?php echo esc_attr( learnkit_button_classes( 'mark_complete_button', 'learnkit-mark-complete' ) ); ?>"
					...
					if ( $quiz ) :
						...
						?>
						<a href="<?php echo esc_url( get_permalink( $quiz->ID ) ); ?>" class="<?php echo esc_attr( learnkit_button_classes( 'take_quiz_button', 'learnkit-quiz-button' ) ); ?>">
			...
			<div class="learnkit-lesson-navigation">
				<?php if ( $prev_lesson_id ) : ?>
					<a href="<?php echo esc_url( get_permalink( $prev_lesson_id ) ); ?>" class="<?php echo esc_attr( learnkit_button_classes( 'prev_lesson_button', 'learnkit-nav-button prev' ) ); ?>">
				...
				<?php if ( $next_lesson_id ) : ?>
					<a href="<?php echo esc_url( get_permalink( $next_lesson_id ) ); ?>" class="<?php echo esc_attr( learnkit_button_classes( 'next_lesson_button', 'learnkit-nav-button next' ) ); ?>">
						Next Lesson <span class="arrow">→</span>
					</a>
				<?php elseif ( $next_module_first_lesson ) : ?>
					<a href="<?php echo esc_url( get_permalink( $next_module_first_lesson['id'] ) ); ?>" class="<?php echo esc_attr( learnkit_button_classes( 'next_lesson_button', 'learnkit-nav-button next next-module' ) ); ?>">
