 ...
 */
require_once LEARNKIT_PLUGIN_DIR . 'includes/class-learnkit-rewrite.php';
 ...
 */
require_once LEARNKIT_PLUGIN_DIR . 'includes/class-learnkit-license.php';
$learnkit_license = new LearnKit_License();
$learnkit_license->register();
